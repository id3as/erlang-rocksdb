...
// status code
ERL_NIF_TERM ATOM_STATUS_CODE_NOT_FOUND;
ERL_NIF_TERM ATOM_STATUS_CODE_CORRUPTION;
ERL_NIF_TERM ATOM_STATUS_CODE_NOT_SUPPORTED;
ERL_NIF_TERM ATOM_STATUS_CODE_INVALID_ARGUMENT;
ERL_NIF_TERM ATOM_STATUS_CODE_IO_ERROR;
ERL_NIF_TERM ATOM_STATUS_CODE_MERGE_IN_PROGRESS;
ERL_NIF_TERM ATOM_STATUS_CODE_INCOMPLETE;
ERL_NIF_TERM ATOM_STATUS_CODE_SHUTDOWN_IN_PROGRESS;
ERL_NIF_TERM ATOM_STATUS_CODE_TIMEDOUT;
ERL_NIF_TERM ATOM_STATUS_CODE_ABORTED;
ERL_NIF_TERM ATOM_STATUS_CODE_BUSY;
ERL_NIF_TERM ATOM_STATUS_CODE_EXPIRED;
ERL_NIF_TERM ATOM_STATUS_CODE_TRY_AGAIN;
ERL_NIF_TERM ATOM_STATUS_CODE_COMPACTION_TOO_LARGE;
ERL_NIF_TERM ATOM_STATUS_CODE_COLUMN_FAMILY_DROPPED;

// status subcode
ERL_NIF_TERM ATOM_STATUS_SUBCODE_NONE; 
ERL_NIF_TERM ATOM_STATUS_SUBCODE_MUTEX_TIMEOUT; 
ERL_NIF_TERM ATOM_STATUS_SUBCODE_LOCK_TIMEOUT; 
ERL_NIF_TERM ATOM_STATUS_SUBCODE_LOCK_LIMIT; 
ERL_NIF_TERM ATOM_STATUS_SUBCODE_NOSPACE; 
ERL_NIF_TERM ATOM_STATUS_SUBCODE_DEADLOCK; 
ERL_NIF_TERM ATOM_STATUS_SUBCODE_STALE_FILE; 
ERL_NIF_TERM ATOM_STATUS_SUBCODE_MEMORY_LIMIT; 
ERL_NIF_TERM ATOM_STATUS_SUBCODE_SPACE_LIMIT; 
ERL_NIF_TERM ATOM_STATUS_SUBCODE_PATH_NOT_FOUND; 
ERL_NIF_TERM ATOM_STATUS_SUBCODE_MERGE_OPERANDS_INSUFFICIENT_CAPACITY; 
ERL_NIF_TERM ATOM_STATUS_SUBCODE_MANUAL_COMPACTION_PAUSED; 
ERL_NIF_TERM ATOM_STATUS_SUBCODE_OVERWRITTEN; 
ERL_NIF_TERM ATOM_STATUS_SUBCODE_TXN_NOT_PREPARED; 
ERL_NIF_TERM ATOM_STATUS_SUBCODE_IO_FENCED; 
ERL_NIF_TERM ATOM_STATUS_SUBCODE_MERGE_OPERATOR_FAILED; 
ERL_NIF_TERM ATOM_STATUS_SUBCODE_MERGE_OPERAND_THRESHOLD_EXCEEDED; 
...
#define ATOM(Id, Value) { Id = enif_make_atom(env, Value); }
  ...
  // status code
  ATOM(erocksdb::ATOM_STATUS_CODE_NOT_FOUND, "notFound");
  ATOM(erocksdb::ATOM_STATUS_CODE_CORRUPTION, "corruption");
  ATOM(erocksdb::ATOM_STATUS_CODE_NOT_SUPPORTED, "notSupported");
  ATOM(erocksdb::ATOM_STATUS_CODE_INVALID_ARGUMENT, "invalidArgument");
  ATOM(erocksdb::ATOM_STATUS_CODE_IO_ERROR, "iOError");
  ATOM(erocksdb::ATOM_STATUS_CODE_MERGE_IN_PROGRESS, "mergeInProgress");
  ATOM(erocksdb::ATOM_STATUS_CODE_INCOMPLETE, "incomplete");
  ATOM(erocksdb::ATOM_STATUS_CODE_SHUTDOWN_IN_PROGRESS, "shutdownInProgress");
  ATOM(erocksdb::ATOM_STATUS_CODE_TIMEDOUT, "timedOut");
  ATOM(erocksdb::ATOM_STATUS_CODE_ABORTED, "aborted");
  ATOM(erocksdb::ATOM_STATUS_CODE_BUSY, "busy");
  ATOM(erocksdb::ATOM_STATUS_CODE_EXPIRED, "expired");
  ATOM(erocksdb::ATOM_STATUS_CODE_TRY_AGAIN, "tryAgain");
  ATOM(erocksdb::ATOM_STATUS_CODE_COMPACTION_TOO_LARGE, "compactionTooLarge");
  ATOM(erocksdb::ATOM_STATUS_CODE_COLUMN_FAMILY_DROPPED, "columnFamilyDropped");

  // status subcode
  ATOM(erocksdb::ATOM_STATUS_SUBCODE_MUTEX_TIMEOUT, "mutexTimeout"); 
  ATOM(erocksdb::ATOM_STATUS_SUBCODE_LOCK_TIMEOUT, "lockTimeout"); 
  ATOM(erocksdb::ATOM_STATUS_SUBCODE_LOCK_LIMIT, "lockLimit"); 
  ATOM(erocksdb::ATOM_STATUS_SUBCODE_NOSPACE, "noSpace"); 
  ATOM(erocksdb::ATOM_STATUS_SUBCODE_DEADLOCK, "deadlock"); 
  ATOM(erocksdb::ATOM_STATUS_SUBCODE_STALE_FILE, "staleFile"); 
  ATOM(erocksdb::ATOM_STATUS_SUBCODE_MEMORY_LIMIT, "memoryLimit"); 
  ATOM(erocksdb::ATOM_STATUS_SUBCODE_SPACE_LIMIT, "spaceLimit"); 
  ATOM(erocksdb::ATOM_STATUS_SUBCODE_PATH_NOT_FOUND, "pathNotFound"); 
  ATOM(erocksdb::ATOM_STATUS_SUBCODE_MERGE_OPERANDS_INSUFFICIENT_CAPACITY, "mergeOperandsInsufficientCapacity"); 
  ATOM(erocksdb::ATOM_STATUS_SUBCODE_MANUAL_COMPACTION_PAUSED, "manualCompactionPaused"); 
  ATOM(erocksdb::ATOM_STATUS_SUBCODE_OVERWRITTEN, "overwritten"); 
  ATOM(erocksdb::ATOM_STATUS_SUBCODE_TXN_NOT_PREPARED, "txnNotPrepared"); 
  ATOM(erocksdb::ATOM_STATUS_SUBCODE_IO_FENCED, "iOFenced"); 
  ATOM(erocksdb::ATOM_STATUS_SUBCODE_MERGE_OPERATOR_FAILED, "mergeOperatorFailed"); 
  ATOM(erocksdb::ATOM_STATUS_SUBCODE_MERGE_OPERAND_THRESHOLD_EXCEEDED, "mergeOperandThresholdExceeded"); 
